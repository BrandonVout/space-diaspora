...
namespace Timer
{
    [RequireComponent(typeof(FloatTimerWarning))]
    public class FloatTimerWarningText : MonoBehaviour
    {
        private Color _defaultColor;
        private FloatTimerWarning _floatTimerWarning;
        ...
        private void Start()
        {
            _floatTimerWarning = gameObject.GetComponent<FloatTimerWarning>();

            _floatTimerWarning.TimerWarningOn += Timer_Warning_On;
            _floatTimerWarning.TimerWarningOff += Timer_Warning_Off;
